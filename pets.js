...
var PET_CATALOG = [
  {
    ...
    audioMap: null,
    growthStages: [
      { level: 1, name: '初生',   threshold: 0,   size: 'w-20 h-20' },
      { level: 2, name: '幼趣',   threshold: 30,  size: 'w-24 h-24' },
      { level: 3, name: '灵动',   threshold: 80,  size: 'w-28 h-28' },
      { level: 4, name: '英武',   threshold: 150, size: 'w-32 h-32' },
      { level: 5, name: '至尊',   threshold: 300, size: 'w-36 h-36' },
    ],
    attributes: {
      element: 'earth',
...

  {
    ...
    name: '哈士奇',
    species: '犬科',
    desc: '西伯利亚雪橇犬，江湖人称"二哈"。拥有天使的面孔和魔鬼的灵魂，拆家能力一流，但那无辜的大眼睛让你永远舍不得生气。',
    personality: '拆家、戏精、热情',
    favoriteFood: '牛肉罐头',
    backstory: '来自西伯利亚的冰天雪地，曾是雪橇犬队的领跑者。因为太过自由散漫被队伍"开除"，从此踏上拆家之路。',
    rarity: 'rare',
    price: 80,
    unlockLevel: 4,
    era: null,
    emoji: '🐺',
    thumbUrl: 'pet_animations/husky/husky-thumb.png',
    animations: {
      idle:  { frames: 1, interval: 3000 },
      click: { frames: 1, interval: 2000 },
      feed:  { frames: 1, interval: 2500 },
    ...
    attributes: {
      element: 'wind',
      baseStats: { strength: 6, agility: 8, vitality: 7, wisdom: 3, charm: 8 },
      growthRates: { strength: 0.6, agility: 0.8, vitality: 0.7, wisdom: 0.3, charm: 0.8 },
    },
    skills: [
      {
        id: 'husky_howl',
        name: '狼嚎',
        desc: '哈士奇仰天长嚎，气势惊人！主人下次打卡获得的经验值增加 30%。',
        unlockLevel: 3,
        cooldown: 3600000,
        type: 'buff',
        effect: { target: 'owner', type: 'xp_boost', value: 0.3, duration: 0, charges: 1 },
        icon: '🐺',
        animation: 'click',
      },
      {
        id: 'husky_destroy',
        name: '拆家突击',
        desc: '哈士奇疯狂拆家后一脸无辜，主人哭笑不得但心情莫名好了——瞬间恢复 18 点心情。',
        unlockLevel: 5,
        cooldown: 7200000,
        type: 'heal',
        effect: { target: 'self', type: 'restore_mood', value: 18 },
        icon: '🏠',
        animation: 'idle',
      },
    ],
...

  {
    ...
    name: '蜥蜴',
    species: '爬行纲',
    desc: '安静的小精灵，总是一动不动地趴在暖石上晒太阳。别被它冷酷的外表骗了，它只是在默默观察这个世界的一切。',
    personality: '冷静、沉稳、观察力强',
    favoriteFood: '小虫子',
    backstory: '来自远古时代的密林深处，经历了亿万年的进化依然保持着最原始的生存智慧。它相信"不动如山"才是最高境界。',
    rarity: 'epic',
    price: 150,
    unlockLevel: 5,
    era: null,
    emoji: '🦎',
    thumbUrl: 'pet_animations/lizard/lizard-thumb.png',
    animations: {
      idle:  { frames: 1, interval: 3000 },
      feed:  { frames: 1, interval: 2500 },
      bath:  { frames: 1, interval: 2500 },
    ...
    attributes: {
      element: 'earth',
      baseStats: { strength: 4, agility: 5, vitality: 6, wisdom: 9, charm: 6 },
      growthRates: { strength: 0.4, agility: 0.5, vitality: 0.6, wisdom: 0.9, charm: 0.6 },
    },
    skills: [
      {
        id: 'lizard_regen',
        name: '断尾再生',
        desc: '蜥蜴展示惊人的再生能力，主人获得 5 分钟内经验获取 +25% 的增益。',
        unlockLevel: 3,
        cooldown: 3600000,
        type: 'buff',
        effect: { target: 'owner', type: 'xp_boost', value: 0.25, duration: 300000 },
        icon: '🔄',
        animation: 'idle',
      },
      {
        id: 'lizard_camouflage',
        name: '隐身术',
        desc: '蜥蜴融入环境完全隐身，主人瞬间恢复 22 点心情。',
        unlockLevel: 5,
        cooldown: 7200000,
        type: 'heal',
        effect: { target: 'self', type: 'restore_mood', value: 22 },
        icon: '🫥',
        animation: 'sleep',
      },
    ],
...
// ============================================================
// 三-B、宠物 AI 人格定义（用于 DeepSeek 对话生成）
// ============================================================

var PET_PERSONALITIES = {
  'teddy': {
    name: '泰迪',
    personality: '温柔、粘人、喜欢撒娇，说话带"~"语气词',
    speech_style: '用"人家"自称，语气温柔可爱，句尾常加"~"或"呢"',
    interests: '最喜欢被抱抱，害怕打雷，喜欢听主人讲故事'
  },
  'border-collie': {
    name: '边牧',
    personality: '聪明、活泼、有点话痨，喜欢用成语但经常用错',
    speech_style: '自称"本汪"，偶尔蹦出搞笑的错用成语，语速快',
    interests: '喜欢追球、算数学题，对数字很敏感'
  },
  'angora-rabbit': {
    name: '安哥拉兔',
    personality: '安静、害羞、爱看书，说话轻声细语',
    speech_style: '自称"兔兔"，喜欢引用诗句或童话句子，声音小小的',
    interests: '最爱胡萝卜和童话故事，喜欢安静地待在角落看书'
  },
  't-rex': {
    name: '小霸王龙',
    personality: '霸气、热血、中二，说话很大声，充满斗志',
    speech_style: '自称"本龙"，喜欢用"吼！"开头，说话像在发表战斗宣言',
    interests: '梦想成为最强的学习战士，把每次打卡当作战斗'
  },
  'capybara': {
    name: '卡皮巴拉',
    personality: '佛系、淡定、什么都无所谓，但内心很温暖',
    speech_style: '说话慢悠悠，喜欢用"嘛~""啦~""哦~"，语气永远很平和',
    interests: '最喜欢泡温泉和发呆，觉得学习也是一种享受'
  },
  'husky': {
    name: '哈士奇',
    personality: '热情、戏精、精力旺盛，经常做出意想不到的事',
    speech_style: '自称"本汪"，说话夸张，喜欢用感叹号，偶尔突然犯傻',
    interests: '喜欢拆东西、奔跑、做白日梦，永远充满活力'
  },
  'lizard': {
    name: '蜥蜴',
    personality: '冷静、沉稳、话少但每句都很有分量',
    speech_style: '说话简短精炼，偶尔冒出哲学感的句子，语气淡定',
    interests: '喜欢晒太阳、观察事物、安静地思考'
  }
};
